...
This repository is a static GitHub Pages site. Keep the root limited to the app shell and deployment files, and place content in purpose-specific directories:

- `index.html` for the hub landing page
- `assets/` for icons and static assets
- `slides/` for HTML slide decks
- `docs/` for technical notes and documentation
- `pages/` for standalone HTML experiences
...
- Prefer lowercase, hyphenated file names such as `claude-codex-workflow-deck.html`
